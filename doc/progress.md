...
## Текущие задачи:
- [x] 1. Настроить CSS @media print для печати
- [x] 2. Реализовать генерацию PDF через pdfmake
- [x] 3. Обновить кнопку Print в header

## Последние действия:
Завершен этап 6: настроена печать с CSS @media print, генерация PDF через pdfmake.
