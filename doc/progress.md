...
## Текущие задачи:
- [x] 1. Создать компонент Search с debounce
- [x] 2. Добавить автодополнение через Strapi API
- [x] 3. Реализовать breadcrumbs
- [x] 4. Добавить back/forward навигацию

## Последние действия:
Завершен этап 5: создан компонент Search с debounce, breadcrumbs, back/forward навигация.
